...
const changeText = document.querySelector("#no");

changeText.addEventListener("click", function() {
  changeText.textContent = "Try again!";
});

function sound(){
    var snd = new Audio('chipi.mp3')//wav is also supported
    snd.play()//plays the sound
}
const audio = new Audio("chipi.mp3");
